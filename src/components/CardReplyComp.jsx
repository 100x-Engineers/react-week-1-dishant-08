...
// Like/repost state comes from the React Query cache via props (updated
// optimistically); memo() keeps sibling replies from re-rendering.
const CardReplyComp = memo(function CardReplyComp({
  text,
  time,
  postId,
  user,
