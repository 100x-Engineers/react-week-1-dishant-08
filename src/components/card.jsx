...
export default function Card({ text }) {
  ...
  return (
    <article className="flex  py-2 px-4 items-start gap-4 border-b border-b-neutral-700">
      <img src={userAvatar} alt="user-avatar" className="shrink-0" />
          ...
          <div className="flex justify-center items-center gap-[0.3125rem]">
            <button className="group">
              <svg
                ...
                fill="none"
              >
                <g className="block group-focus:hidden">
                  <path
                ...
                <g className="hidden group-focus:block">
                  <path
